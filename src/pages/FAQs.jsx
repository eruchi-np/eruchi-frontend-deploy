...
const faqs = [
    ...
    { id: 5, question: "Is there really no catch? Will I ever be asked to pay for something later?", answer: "No catch, no hidden charges. You'll never be asked to pay for samples or shipping. We simply connect you with brands looking for genuine product samplers." },
    { id: 6, question: "Do I have to review the products?", answer: "Reviews are completely optional! But if you love (or don't love) a product, your feedback helps brands improve and create better products." },
