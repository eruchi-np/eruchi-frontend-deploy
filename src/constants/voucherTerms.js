...
export const VOUCHER_TERMS = [
  ...
  "Redeemed credits are non-refundable once the voucher is claimed.",
  "eRuchi may withhold or cancel an offer if fraud is detected in credit redemption.",
  "The voucher must be redeemed at the merchant within 14 days of being claimed, or it will expire.",
