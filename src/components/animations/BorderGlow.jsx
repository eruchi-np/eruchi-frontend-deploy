...
const BorderGlow = ({
  ...
  return (
    <>
      {/* Inline Encapsulated CSS Runtime Block */}
      <style dangerouslySetInnerHTML={{ __html: `
        .border-glow-card {
          ...
          overflow: visible;
          box-shadow: 
            rgba(0, 0, 0, 0.01) 0px 1px 3px 0px, 
            rgba(0, 0, 0, 0.02) 0px 4px 12px -3px !important;
        ...
        .border-glow-card:hover {
          ...
          box-shadow: 
            rgba(0, 0, 0, 0.04) 0px 4px 6px -1px, 
            rgba(0, 0, 0, 0.08) 0px 10px 25px -5px !important;
        }
        ...
        /* Edge Background Reflection Fill Matrix */
        .border-glow-card::after {
          border: 1px solid transparent;
          background:
        ...
        /* Soft External Ray Glow Layer Wrapper */
        .border-glow-card > .edge-light {
