...
export default function Stepper({
  ...
  onBeforeNext = null, // FIX: was silently ignored before via ...rest spread
  ...
  const handleNext = () => {
    if (!isLastStep) {
      // FIX: run validation before advancing; abort if it returns false
...
function StepConnector({ isComplete }) {
  ...
  return (
    <div className="step-connector bg-gray-200">
      <motion.div
